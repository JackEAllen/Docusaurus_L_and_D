---
slug: Release
title: IBEX Release 10.0.0
authors:
  - name: Jack Allen
    title: Friendly Neighborhood Developer
    url: https://github.com/JackEAllen
    image_url: https://github.com/JackEAllen.png
  - name: ISIS Experiment Controls Group
    title: IBEX Team
    url: https://github.com/ISISComputingGroup/
    image_url: https://github.com/ISISComputingGroup.png
tags: [Releases, Documentation]
---

![Docusaurus Plushie](./IBEX_logo.jpg)

# IBEX 10.0.0 Has Been Released!

Through bugs, memory leaks and code, we are pleased to announce the release of IBEX 10.0.0!

This release involved a lot of hard work from the most dedicated and coolest developers within ISIS - The IBEX Team. 

We hope you enjoy the new features and improvements that have been added to IBEX 10.0.0.

Below you can find the latest release notes of IBEX 10.0.0 for your perusal.
