---
id: Reflectometers
title: Reflectometers Page
slug: /Home/project_overview/Design_Documents/Reflectometers
tags:
  - DeveloperDocs
  - DesignDocs
  - Instrument
...
![Reflectometer Schematic](/img/Instrument_and_Devices/Reflectometry/refl_beamline_setup.png)
...
- [Reflectometer glossary and commonly used phrases](Reflectometers/Reflectometry_Glossary)
- [Setup and science behind the experiment](Reflectometers/Reflectometers_Science): What science is trying to achieve
- [Reflectometers Beam Height Calculation](https://github.com/ISISComputingGroup/ibex_developers_manual/wiki/Reflectometers-Beam-Height-Calc): Calculate motor positions easily
- [Reflectometry-Configuration](https://github.com/ISISComputingGroup/ibex_developers_manual/wiki/Reflectometry-Configuration): Configuration documentation
- [Reflectometry IOC](https://github.com/ISISComputingGroup/ibex_developers_manual/wiki/Reflectometry-IOC)
- [Architecture](https://github.com/ISISComputingGroup/ibex_developers_manual/wiki/Reflectometry-IOC#design-details)
    - [Beamline](https://github.com/ISISComputingGroup/ibex_developers_manual/wiki/Reflectometry-Beamline-Object): Coordinating object
    - [User Parameters](https://github.com/ISISComputingGroup/ibex_developers_manual/wiki/Reflectometry-Beamline-Parameters): How user parameters work, including definition of theta
    - [Components](https://github.com/ISISComputingGroup/ibex_developers_manual/wiki/Reflectometry-Geometry-Components): Calculation of positions from user parameters
    - [Driving layer](https://github.com/ISISComputingGroup/ibex_developers_manual/wiki/Reflectometry-Composite-Driving-Layer): Driving of motors (including engineering corrections, synchronisation and out of beam positions)
- [Reflectometry Testing](https://github.com/ISISComputingGroup/ibex_developers_manual/wiki/Reflectometry-Testing)
- [Reflectometry Troubleshooting and FAQ](https://github.com/ISISComputingGroup/ibex_developers_manual/wiki/Reflectometry-Troubleshooting-and-FAQ)
...
<details>
<summary>Answered 06/2020</summary>
<div>
