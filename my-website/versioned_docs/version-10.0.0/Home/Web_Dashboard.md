...
id: Web_Dashboard
title: Web Dashboard
description: Web Dashboard page for developers
slug: /Home/Web_Dashboard
---
...
![Architecture](/img/web_dashboard/dataweb_architecture.png)
...
The archive engine shown in the [high level design](https://github.com/ISISComputingGroup/ibex_developers_manual/wiki/High-Level-Architectural-Design) produces internal webpages that provides live data on various PVs in HTML format:
...
There are also parts of the system running on a central [webserver](https://github.com/ISISComputingGroup/ibex_developers_manual/wiki/Webserver), which provides external access.
