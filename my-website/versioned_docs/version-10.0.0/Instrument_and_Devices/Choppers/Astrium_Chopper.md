---
id: Astrium_Chopper
title: Astrium Chopper
description: Astrium Chopper Page
slug: /Instrument_and_Devices/Choppers/Astrium_Chopper
...
The IOC for the Astrium choppers works similarly to that of the [Mk3](MK3_Chopper) in that it uses a .NET C# DLL to communicate with the servers running the chopper control programs. The architecture can be described as:

![](/img/Instrument_and_Devices/Choppers/Astrium.svg)
...
![](/img/Instrument_and_Devices/Choppers/Astrium_Monitoring_Crate.JFIF)
